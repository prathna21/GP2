...
public class Donor implements Serializable {
     ...
     *
     * @param card The card to be issued
     ...
     * @param cardNumber The card number issued to donor
     * @return True if the card is removed
     */
    public boolean removeCreditCard(String donorID, String cardNumber) {
        for ( ListIterator<CreditCard> iterator = cards.listIterator(); iterator
            .hasNext(); ) {
    ...
    public boolean removeBankAccount(String donorID, String bankAccount) {
        for ( ListIterator<BankAccount> iterator = banks.listIterator(); iterator
            .hasNext(); ) {
    ...
    /**
     * This method will remove all transactions associated with a removed Donor object
     *
     */
    ...
    public void getAccountIssued() {
        String string =
            "| Donor Name: " + name + " | ID: " + id + " | Phone: " + phone +
                " |\n";
        getCardsIssued();
        getBanksIssued();
    }
    ...
    public Iterator<BankAccount> getBanksIssued() {
        ...
        for ( Iterator<BankAccount> iterator = banks.iterator(); iterator
            .hasNext(); ) {
     ...
     * Setter for name
     *
     * @param newName Donor's new name
     */
     ...
     * Setter for phone
     *
     * @param newName Donor's new phone
     */
     ...
     *
     * @param id ID of the donor who should be compared
