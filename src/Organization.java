...
public class Organization implements Serializable {
     ...
     *
     * @param donorID The ID of donor
     * @param creditCard Credit card of donor
     * @param amount Credit card amount to be donated each month
     * @return True if it's added
     */
    public CreditCard addCreditCard(String donorID,
                                    String creditCard,
                                    int amount) {
    ...
    public BankAccount addBankAccount(String donorID,
                                      String bankAccount,
                                      int amount) {
    ...
    /**
     * List all the transaction that has been process for each credit cards and amount
     *
    ...
    public Iterator listPaymentInfo() {
        if ( donorList.getList() != null ) {
            Iterator<Donor> result = donorList.getList().iterator();
            return result;
        } else {
    ...
    /**
     * Display selected donor name, ID, phone number, credit card and amount information
     *
     * @param donorID The ID of donor
     ...
     *
     * @param donorID The ID of donor
     * @param cardNumber The credit card number of donor
