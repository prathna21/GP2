...
public class Transaction implements Serializable {
	...
	/**
	 * Getter for the type of account added
	 *
	...
	public String toString() {
		if (type.equals("Credit Card")) {
			return ("| Credit Card: " + paymentNumber + "\t| Payment: " + amount + "\t| Date: " + getDate());
		} else {
			return ("| Bank Account: " + paymentNumber + "\t| Payment: " + amount + "\t| Date: " + getDate());
		}
